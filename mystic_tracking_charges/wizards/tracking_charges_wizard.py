...
class TrackingWizard(models.TransientModel):
    ...
    fleet_ids = fields.Many2many('tracking.charges.line')
        ...
        for record in self.fleet_ids:
            ...
            # if record.date_from <= self.date and record.date_to >= self.date:
                ...
                line_val.append((0, 0, {
                    ...
                    'analytic_tag_ids': record.tracking_charge_id.branch_id.analytical_account_tag_id,
                    'analytic_account_id': record.tracking_charge_id.analytical_account_id.id,
